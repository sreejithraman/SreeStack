...
When a merge changes a descendant's base, history, diff, or check target, retarget it to the delivery base when needed, restack it, run `/pr-prep`, and recheck readiness before its merge.
