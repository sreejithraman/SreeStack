...
Rules enforced by the [asc-aso-audit](../guide.md) guide. Each rule links to the check that tests it.
...
- **Screenshot captions:** write clear captions for users. Treat claims about OCR indexing or a June 2025 ranking change as unverified; do not base recommendations on them.
