...
Use this guide when you need to build an app from source and prepare it for App Store Connect. Prefer `asc xcode archive` and `asc xcode export` over raw `xcodebuild` recipes when they fit the project.
...
[asc-ad-hoc-distribution](../asc-ad-hoc-distribution/guide.md) guide instead of assembling those stages manually.
...
- Verify profiles with the [asc-signing-setup](../asc-signing-setup/guide.md) guide.
...
- For submission readiness, use [asc-submission-health](../asc-submission-health/guide.md).
