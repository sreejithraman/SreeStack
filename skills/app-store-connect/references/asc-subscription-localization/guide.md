...
Use this guide to bulk-create or bulk-update display names and, where supported,
...
- Use the [asc-id-resolver](../asc-id-resolver/guide.md) guide if you only have app names instead of IDs.
