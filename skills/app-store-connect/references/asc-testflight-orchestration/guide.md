...
Use this guide when managing TestFlight testers, groups, and build distribution.
...
- Prefer IDs for deterministic operations; use the [ID resolver guide](../asc-id-resolver/guide.md) when needed.
