...
Use this guide to keep App Store Connect (ASC) and RevenueCat aligned, including creating missing ASC items and mapping them to RevenueCat resources.
...
- Never auto-delete ASC or RevenueCat resources in this guide.
