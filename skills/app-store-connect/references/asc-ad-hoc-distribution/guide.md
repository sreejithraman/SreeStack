...
into a private, verified install link for registered devices. Use the [TestFlight](../asc-testflight-orchestration/guide.md) or
[App Store release](../asc-release-flow/guide.md) guide instead when the build should go through Apple-hosted
distribution.
