...
Use [asc-screenshot-resize](../../asc-screenshot-resize/guide.md) or [asc-shots-pipeline](../../asc-shots-pipeline/guide.md) for screenshot production. Return here after the files pass validation and are uploaded.
