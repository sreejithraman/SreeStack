...
Use this guide when you need to create or renew signing assets for iOS/macOS apps.
...
[asc-ad-hoc-distribution](../asc-ad-hoc-distribution/guide.md) guide when these signing effects should be bound into
