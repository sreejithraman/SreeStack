...
Use this guide to create a new App Store Connect app by driving the web UI.
...
## Notes
- This guide is a workaround for a missing public API. Apple's docs explicitly state: "Don't use this API to create new apps; instead, create new apps on the App Store Connect website."
