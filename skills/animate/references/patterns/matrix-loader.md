...
The reduced-motion rule stops dot animations. Keep a steady loading indicator while work runs. Follow the [implementation checks](../implementation.md) for JavaScript cancellation and preference changes.
