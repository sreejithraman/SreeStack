...
The reduced-motion rule stops icon and particle animations. Apply the final liked or unliked appearance without relying on keyframes, and cancel decorative work. Follow the [implementation checks](../implementation.md) for JavaScript cancellation and preference changes.
